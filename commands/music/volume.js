module.exports = {
    ...
    execute(client, message, args) {
        ...
        if (Math.round(parseInt(args[0])) < 0 || Math.round(parseInt(args[0])) > 200) return message.channel.send(`${client.emotes.error} - Please enter a valid number (between 0 and 200) !`);
